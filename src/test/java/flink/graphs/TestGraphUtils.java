...
public class TestGraphUtils {
	...
	/**
	 *  Also create a graph with at least one vertex that has no ingoing/outgoing edge
	 */
	public static final DataSet<Tuple2<Long, Long>> getLongLongVertexData2(
			ExecutionEnvironment env) {
		List<Tuple2<Long, Long>> vertices = new ArrayList<Tuple2<Long, Long>>();
	...
	public static final DataSet<Tuple3<Long, Long, Long>> getLongLongEdgeData2(
			ExecutionEnvironment env) {
		List<Tuple3<Long, Long, Long>> edges = new ArrayList<Tuple3<Long, Long, Long>>();
		edges.add(new Tuple3<Long,Long, Long>(0L, 1L, 1L));
		edges.add(new Tuple3<Long,Long, Long>(0L, 2L, 2L));
		edges.add(new Tuple3<Long,Long, Long>(1L, 2L, 6L));
		edges.add(new Tuple3<Long,Long, Long>(2L, 3L, 4L));
		edges.add(new Tuple3<Long,Long, Long>(3L, 1L, 3L));
		edges.add(new Tuple3<Long,Long, Long>(3L, 4L, 5L));

		return env.fromCollection(edges);
	}

	public static final List<Tuple2<Long, Long>> vertexInputData(Graph<Long, Long, Long> graph, ExecutionEnvironment env) throws Exception {
